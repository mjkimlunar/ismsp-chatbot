...
export function buildPrompt(question: string, hits: Retrieved[]): string {
  ...
  return [
    ...
    "★ 최우선 원칙: 아래 [자료]를 꼼꼼히 읽으세요. 질문에 대한 답이 조각 안에 있으면 반드시 그 내용을 답하세요. '자료에 없다'고 답하기 전에 모든 조각을 다시 확인하세요. 조각에 답이 있는데 '없다'고 하는 것은 가장 큰 실수입니다.",
    "근거 조각에 구체적인 숫자·기간·기한·비율·금액·횟수·조건이 명시되어 있으면, 해당 수치를 빠뜨리지 말고 반드시 답변에 그대로 인용하세요. '3개월 이내', '연 1회 이상', '5년' 같은 핵심 정보를 '일정 기간' 등으로 뭉뚱그리지 마세요.",
    weakNote,
